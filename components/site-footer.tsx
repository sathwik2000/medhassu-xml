      ...
      <div className="container py-10">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold">Medhasuu</span>
            </div>
            <p className="text-sm text-muted-foreground">
              Empowering learners with interactive courses and personalized learning paths.
            </p>
          </div>
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/learning-paths" className="text-muted-foreground hover:text-foreground">
                  Learning Paths
                </Link>
              </li>
              <li>
        ...
        <div className="mt-10 border-t pt-6 flex flex-col sm:flex-row items-center justify-between">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Medhasuu. All rights reserved.
          </p>
